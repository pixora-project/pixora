...
<head>
    ...
    <title>Deluxe Gallery : Edit informations</title>
...
<body id="login_page">
    <?php if (!empty($_SESSION['editacc'])): ?>
        <div class="alert alert-success m-0">
            <?= $_SESSION['editacc']; ?>
            <button type="button" class="btn btn-close" data-bs-dismiss="alert"></button>
        </div>
        <?php unset($_SESSION['editacc']); ?>
    <?php endif; ?>
    <div class="dv1">
        ...
        <div class="login-box text-center p-0 row">
            <div>
                <img src="outils/pngs/logo.png" class="img-fluid" width="300px" alt="logo" title="Welcome to DeluxeGallery.">
            </div>
                    ...
                    <div>
                        <div class="form-floating mt-2 mb-2">
                            <input type="email" id="useremail" class="form-control" name="useremail" role="text"
                                placeholder="Type your email ..." value="<?= $_SESSION['px_email']; ?>">
                        ...
                        <!-- <div class="mt-2 mb-2">
                            You don't have a account ? <a href="signup.html">Sign up</a>
                        </div> -->
                        <div class="mt-2 mb-2">
